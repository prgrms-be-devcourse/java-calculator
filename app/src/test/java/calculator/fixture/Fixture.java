...
public class Fixture {
    ...
    public static String ANSWER_OF_ADD_N_MIN = "-3";
    public static String EXP_OF_DIV_N_MUL = "2 * 3 / 4";
    public static String ANSWER_OF_DIV_N_MUL = "1";
    public static String EXP_OF_ADD_N_DIV = "2 + 4 / 4";
    public static String ANSWER_OF_ADD_N_DIV = "3";
    public static String EXP_OF_BRACKET = "2 * (3 + 5)";
    public static String ANSWER_OF_BRACKET = "16";
