...
class OperatorCalculationTest {
    ...
    static Stream<Arguments> whenPlusIntegerCalculationThenSuccessDummy() {
        return Stream.of(
                ...
                Arguments.arguments(2000000000, 2000000, "2002000000"),
                Arguments.arguments(-1, -2, "-3"),
                Arguments.arguments(-1, -3, "-4"),
                Arguments.arguments(-1, -4, "-5"),
                Arguments.arguments(-1, -10, "-11"),
    ...
    static Stream<Arguments> whenMinusIntegerCalculationThenSuccessDummy() {
        return Stream.of(
                ...
                Arguments.arguments(2000000000, 2000000, "1998000000"),
                Arguments.arguments(-1, -2, "1"),
                Arguments.arguments(-1, -3, "2"),
                Arguments.arguments(-1, -4, "3"),
                Arguments.arguments(-1, -10, "9"),
    ...
    static Stream<Arguments> whenDivideIntegerCalculationThenSuccessDummy() {
        return Stream.of(
                Arguments.arguments(2, 1, "2.000000000000000"),
                Arguments.arguments(3, 1, "3.000000000000000"),
                Arguments.arguments(4, 1, "4.000000000000000"),
                Arguments.arguments(10, 1, "10.000000000000000"),
                Arguments.arguments(10, 10, "1.000000000000000"),
                Arguments.arguments(100, 10, "10.000000000000000"),
                Arguments.arguments(1000, 10, "100.000000000000000"),
                Arguments.arguments(2000000000, 2000000, "1000.000000000000000"),
                Arguments.arguments(-2, -1, "2.000000000000000"),
                Arguments.arguments(-3, -1, "3.000000000000000"),
                Arguments.arguments(-4, -1, "4.000000000000000"),
                Arguments.arguments(-10, -1, "10.000000000000000"),
    ...
    static Stream<Arguments> whenPlusDoubleCalculationThenSuccessDummy() {
        return Stream.of(
                ...
                Arguments.arguments(2000000000.998, 2000000.002, "2002000001.000"),
                ...
                Arguments.arguments(-10, -1, "-11.0"),
                Arguments.arguments(-10, -10, "-20.0"),
                Arguments.arguments(-10, -100, "-110.0"),
                Arguments.arguments(-10, -1000, "-1010.0"),
                Arguments.arguments(-2000000000, -2000000, "-2002000000.0")
        );
    }
    ...
    static Stream<Arguments> whenMinusDoubleCalculationThenSuccessDummy() {
        return Stream.of(
                ...
                Arguments.arguments(2000000000.1, 2000000.1, "1998000000.0"),

                Arguments.arguments(-1, -2, "1.0"),
                Arguments.arguments(-1, -3, "2.0"),
                Arguments.arguments(-1, -4, "3.0"),
                Arguments.arguments(-1, -10, "9.0"),
                Arguments.arguments(-1, -100, "99.0"),
                Arguments.arguments(-1, -1000, "999.0"),
                Arguments.arguments(-10, -1, "-9.0"),
                Arguments.arguments(-10, -10, "0.0"),
                Arguments.arguments(-10, -100, "90.0"),
                Arguments.arguments(-10, -1000, "990.0"),
                Arguments.arguments(-2000000000, -2000000, "-1998000000.0")
        );
    }
    ...
    static Stream<Arguments> whenDivideDoubleCalculationThenSuccessDummy() {
        return Stream.of(
                Arguments.arguments(2.4, 1.2, "2.000000000000000"),
                Arguments.arguments(3.4, 1.2, "2.833333333333333"),
                Arguments.arguments(4.4, 1.2, "3.666666666666667"),
                Arguments.arguments(10.4, 1.2, "8.666666666666667"),
                Arguments.arguments(10.4, 10.2, "1.019607843137255"),
                Arguments.arguments(100.4, 10.2, "9.843137254901961"),
                Arguments.arguments(1000.4, 10.2, "98.078431372549020"),
                Arguments.arguments(2000000000.4, 2000000.2, "999.999900200009980"),
