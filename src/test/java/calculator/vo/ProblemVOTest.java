...
class ProblemVOTest {
    ...
    @Test
    void 문제_입력_예외1() {
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class, () -> new ProblemVO("1+ 2 * 300"));
    ...
    @Test
    void 문제_입력_예외2() {
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class, () -> new ProblemVO("100 + &$@#$! ㅋㅋ"));
        assertThat(e.getMessage()).isEqualTo("잘못된 형식입니다");
    }
    ...
    @Test
    void 문제_입력_예외3() {
        IllegalArgumentException e = assertThrows(IllegalArgumentException.class, () -> new ProblemVO("1 +* 300"));
        assertThat(e.getMessage()).isEqualTo("잘못된 형식입니다");
    }
